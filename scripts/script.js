...
$(document).ready(function () {
    ...
    //spawn in all resources
        ...
        //rRNA nucleotides
        $("#t1").append("<div id = 'ta1' class = 'tU' style = 'padding-bottom: 80px;'>A</div>");
        $("#t1").append("<div id = 'ta2' class = 'tC' style = 'padding-bottom: 80px; padding-left: 50px;'>A</div>");
        $("#t1").append("<div id = 'ta3' class = 'tA' style = 'padding-bottom: 80px; padding-left: 100px;'>A</div>");
