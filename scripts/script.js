...
var animations = [[[".helicase", "+=50px", "+=0px"]],
                  ...
                  [["#t1", "+=0px", "+=90px"], ["#aa1", "+=0px", "+=90px"]],
                  [["#t2", "+=0px", "+=0px", "unhide"], ["#aa2", "+=0px", "+=0px", "unhide"]],
                  [["#t2", "+=0px", "+=90"], ["#aa2", "+=0px", "+=90px"]],
                  [["#bond1", "+=0px", "+=0px", "unhide"]],
                  [["#r1", "-=150px", "-=0px"], ["#r2", "-=150px", "-=0px"], ["#r3", "-=150px", "-=0px"], ["#r4", "-=150px", "-=0px"], ["#r5", "-=150px", "-=0px"], ["#r6", "-=150px", "-=0px"], ["#r7", "-=150px", "-=0px"], ["#r8", "-=150px", "-=0px"], ["#r9", "-=150px", "-=0px"], ["#r10", "-=150px", "-=0px"], ["#r11", "-=150px", "-=0px"], ["#r12", "-=150px", "-=0px"], ["#t1", "-=150px", "+=0"], ["#t2", "-=150px", "+=0"], ["#aa2", "-=150px", "+=0"], ["#aa1", "-=150px", "+=0"], ["#bond1", "-=150px", "+=0px"]],
                  [["#t1", "+=0px", "+=0px", "hide"]],
